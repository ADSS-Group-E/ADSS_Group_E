package PresentationLayer.WorkersOptionsMenus;
...
import static PresentationLayer.Workers_Transport.Main.systemInitialize;

public class MainWorkersOptionsMenu extends OptionsMenu{

    private final WorkersFacade workersFacade = WorkersFacade.getInstance();

    public MainWorkersOptionsMenu(CommandLineInterface parentCLI) {
        super(parentCLI);
        int i=1;
        //branch manager functions:
        options.put(i++, new Option("Create new weekly assignment by the date of sunday", this::createNewDelivery));
        options.put(i++, new Option("Replace a shift between two workers", this::deleteDelivery));
        options.put(i++, new Option("Display current day shift assignment by branch ID", this::changeDate));
        options.put(i++, new Option("Display shift assignment by date and by branch ID", this::changeTime));

        //branch manager and HRD
        options.put(i++, new Option("Search worker by worker ID", this::changeWeight));

        //branch manager functions:
        options.put(i++, new Option("Display workers by qualification,shift and by branch ID", this::changeTruck));
        options.put(i++, new Option("Display weekly assignment by branch ID and by date", this::changeDriver));
        options.put(i++, new Option("Display personal details of a worker by his ID", this::addOrder));
        //all allowed
        options.put(i++, new Option("Display your personal details", this::removeOrder));
        options.put(i++, new Option("Display workers by branch ID", this::changeStatus));

        //HRD functions:
        options.put(i++, new Option("Create new weekly shifts demands by branch ID,the date of sunday", this::createNewDelivery));
        options.put(i++, new Option("Add new worker", this::deleteDelivery));
        options.put(i++, new Option("Remove worker", this::changeDate));
        options.put(i++, new Option("Change worker branch", this::changeTime));
        options.put(i++, new Option("Display current day shift assignment by branch ID", this::changeWeight));
        options.put(i++, new Option("Display shift assignment by date and by branch ID", this::changeTruck));
        options.put(i++, new Option("Display workers by Qualification, shift and by branch ID", this::createNewDelivery));
        options.put(i++, new Option("Display weekly assignment by branchID and by date", this::deleteDelivery));
        options.put(i++, new Option("Update worker's details", this::changeDate));
        options.put(i++, new Option("Add new branch", this::changeTime));
        options.put(i++, new Option("Add new qualifications by worker ID", this::changeWeight));
        options.put(i++, new Option("Display personal details of a worker by his ID", this::changeTruck));


        //all
        options.put(i++, new Option("Create new weekly Available Work days by the date of sunday", this::createNewDelivery));
        options.put(i++, new Option("Display current day shift assignment of your branch", this::deleteDelivery));
        options.put(i++, new Option("Display the daily shift assignment of your branch by date", this::changeDate));
        options.put(i++, new Option("Display weekly assignment by branchID and by date", this::changeTime));
        options.put(i++, new Option("Back", this::changeTruck));
        ...
        private static int createSystemWithoutInitialize(int stop) {
            return PresentationLayer.Workers_Transport.MenuWorkers.menuForCreate(stop);
        }
                ...
                if(responseBranchID.isErrorOccurred())
                    ...
                    if(listResponseT.isErrorOccurred())
                        ...
                        if (qualifications.contains(QualificationsDTO.BranchManager)) {
                            stop = PresentationLayer.Workers_Transport.MenuWorkers.branchManagerMenu(workerDTO,branchID, DriverController.getInstance().getDrivers());

                        } else if (workerDTO.getQualifications().contains(QualificationsDTO.Human_Resources_Director)) {
                            stop = PresentationLayer.Workers_Transport.MenuWorkers.HRDMenu(workerDTO,branchID);

                        }
                        else {
                            stop = PresentationLayer.Workers_Transport.MenuWorkers.otherWorkerMenu(workerDTO,branchID);
                        }
                    }
