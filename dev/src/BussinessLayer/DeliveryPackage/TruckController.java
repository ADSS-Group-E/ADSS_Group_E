...
public class TruckController {
    ...
    public Truck getTruck(String id) throws Exception {
        Truck t=DataAccessLayer.Transports.Truck.checkTruck(id);
        if (t==null)
    ...
    public void addTruck(Truck truck) throws Exception {
        if (DataAccessLayer.Transports.Truck.checkTruck(truck.getId())!=null)
            throw new Exception("the truck already exists");
        this.trucks.put(truck.getId(), truck);
        DataAccessLayer.Transports.Truck.insertTruck(new DTO.Truck(truck.getId(),truck.getModel(),truck.getNetoWeight(),truck.getTotalWeight(),truck.isUsed()));
    }
    ...
    public void printTrucks() throws SQLException {
        DataAccessLayer.Transports.Truck.printTrucks();
    }
}
